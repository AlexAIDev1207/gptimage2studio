...
export async function getSettings() {
  ...
  "premium-yearly": "prod_xxx"
    ...
    {
      name: 'kie_webhook_hmac_key',
      title: 'Kie.ai Webhook HMAC Key',
      type: 'password',
      placeholder: '',
      group: 'kie',
      tab: 'ai',
      tip: 'Used to verify Kie callback signatures.',
    },
    {
      name: 'kie_custom_storage',
      title: 'Kie eager storage',
      type: 'switch',
      value: 'false',
      group: 'kie',
      tab: 'ai',
      tip: 'Keep false for fast preview; mirror to R2 via callback/background endpoint.',
    },
    {
      name: 'gptimage2_1k_credits',
      title: 'GPT Image 2 1K Credits',
      type: 'number',
      value: '6',
      group: 'kie',
      tab: 'ai',
    ...
    {
      name: 'gptimage2_2k_credits',
      title: 'GPT Image 2 2K Credits',
      type: 'number',
      value: '10',
      group: 'kie',
      tab: 'ai',
    ...
    {
      name: 'gptimage2_4k_credits',
      title: 'GPT Image 2 4K Credits',
      type: 'number',
      value: '16',
      group: 'kie',
      tab: 'ai',
